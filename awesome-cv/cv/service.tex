...
%---------------------------------------------------------
  \cventry
    {RSS, ICRA, IROS, FSR, MFI, CRV, IJRR, T-RO, JFR, IEEE RAS} % Affiliation/role
  ...
  \cventry
    ...
    {Organizer{\awesomesep}Debates on the Future of Robotics Research Workshop} % Organization/group
    {Various locations} % Location
    {2019-2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
  ...
  \cventry
    ...
    {Postgraduate Affiliate{\awesomesep}Vector Institute for Artificial Intelligence} % Organization/group
...
%        \item Member of the Vector Institute Social Committee.
  ...
  \cventry
    ...
    {Invited Participant{\awesomesep}RSS Pioneers Workshop} % Organization/group
  ...
  \cventry
    {Robotics: Science and Systems} % Affiliation/role
    {Student Mentor{\awesomesep}Inclusion@RSS} % Organization/group
    {Pittsburgh, USA} % Location
    {2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%    {Graduate Student Representative{\awesomesep}Faculty Council} % Organization/group
%    {Toronto, Canada} % Location
%    {2017-2018} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%  \cventry
%    {University of Toronto Faculty of Applied Science and Engineering} % Affiliation/role
%    {Graduate Student Representative{\awesomesep}Community Affairs \& Gender Issues Committee} % Organization/group
%    {Toronto, Canada} % Location
%    {2017-2018} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%    {President{\awesomesep}Aerospace Students' Association} % Organization/group
%    {Toronto, Canada} % Location
%    {2016-2017} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%  \cventry
%    {University of Toronto Faculty of Applied Science and Engineering} % Affiliation/role
%    {Co-founder / Aerospace Representative{\awesomesep}Graduate Engineering Council of Students} % Organization/group
%    {Toronto, Canada} % Location
%    {2016-2017} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%  \cventry
%    {University of Toronto Institute for Aerospace Studies} % Affiliation/role
%    {Student Member{\awesomesep}UTIAS Student Experience Committee} % Organization/group
%    {Toronto, Canada} % Location
%    {2015-2017} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%    {Re-founder / Director{\awesomesep}SEDS-Canada} % Organization/group
%    {Toronto, Canada} % Location
%    {2014-2017} % Date(s)
%    {
%      \begin{cvitems} % Description(s) of experience/contributions/knowledge
