...
%---------------------------------------------------------
  \cventry
    {Planning ML{\awesomesep}OxaDriver{\awesomesep}Previously Tech Lead Manager (Prediction)} % Job title
    {Staff Engineer, Tech Lead Manager{\awesomesep}Oxa (formerly Oxbotica)} % Organization
